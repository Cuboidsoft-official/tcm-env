...
const categoryDetails = {
  inform: {
    ...
    badgeBg: "#EEECFE",
    badgeColor: "#5B3CF5",
    title: "TCM One Information Tech",
    subtitle: "Full Stack Web Dev, Python, AI/ML & DevOps",
    categoryKey: "TCM One Information Tech",
    icon: "play",
    iconBg: "#EEECFE",
    iconColor: "#5B3CF5",
  ...
  academy: {
    ...
    badgeBg: "#FEE2E2",
    badgeColor: "#D13B45",
    title: "TCM One Academy (Soon)",
    subtitle: "NEET, JEE Main & Academic Exams (Launching Soon)",
    icon: "school",
    iconBg: "#FEE2E2",
    iconColor: "#D13B45",
    banners: [
      {
        id: "b_ac1",
        tag: "COMING SOON 🚀",
        title: "NEET & JEE Batches\nLaunching Soon",
        subtitle: "Currently 100% focused on IT & Tech Careers on TCM One",
  ...
  govt: {
    ...
    badgeBg: "#FFF8EC",
    badgeColor: "#E7A900",
    title: "TCM One Government (Soon)",
    subtitle: "UPSC, SSC CGL & Banking (Launching Soon)",
    icon: "bank",
    iconBg: "#FFF8EC",
    iconColor: "#E7A900",
    banners: [
  ...
  career: {
    id: "career",
    badge: "IT CAREERS & PLACEMENTS",
    badgeBg: "#EBF5FF",
    badgeColor: "#2F79B9",
    title: "TCM One IT Placements",
    subtitle: "Software Engineering Internships & Hiring Drives",
    icon: "briefcase",
    iconBg: "#EBF5FF",
    iconColor: "#2F79B9",
    banners: [
