...
export default function PartnerDashboardScreen({ session, onBack }) {
  ...
  const partnerCategory = user.partnerCategory || 'TCM Partner Institute';
    ...
    switch (type) {
      case 'profile_picture':
        setSelectedSheetItem({
          ...
          details: 'Your official verified institute emblem displayed across TCM search & student course cards.',
          image: logoUrl
        });
        break;
      case 'gallery_photos':
      ...
      case 'description':
        setSelectedSheetItem({
          ...
          details: user.bio || `${instituteName} is an accredited educational partner with TCM.`
        });
        break;
      case 'existing_courses':
        setSelectedSheetItem({
          ...
          details: existingCourses.length > 0 ? 'Programs currently offered at your institute under TCM accreditation.' : 'No courses registered yet.',
          ...
          <>
            ...
            <View style={styles.overviewGrid}>
              <View style={styles.overviewRow}>
                ...
                >
                  ...
                  <Text style={styles.statBoxTitle} numberOfLines={1}>Students from TCM</Text>
            ...
            <View style={styles.summaryGrid}>
              <View style={[styles.summaryCard, { backgroundColor: theme.cardBg || colors.card, borderColor: theme.border || colors.border }]}>
                <Text style={[styles.summaryLabel, { color: theme.subtext || colors.muted }]}>Students from TCM</Text>
          ...
          <View style={{ marginBottom: 16 }}>
            ...
            <View style={[styles.card, { backgroundColor: colors.lavender, borderColor: colors.lavenderLine, padding: 16 }]}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={{ fontFamily: 'Poppins_600SemiBold', color: colors.ink, fontSize: 14 }}>TCM Certified Instructors</Text>
