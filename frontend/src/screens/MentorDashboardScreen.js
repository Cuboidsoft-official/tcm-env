  ...
  function checkApprovalGuard(actionName = "This feature") {
    if (!isApproved) {
      Alert.alert(
        ...
        `Your mentor profile is currently under review by TCM One Administration. ${actionName} will be enabled once your account is verified.`
      );
      return false;
    }
    return true;
          ...
          <View style={{
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 11, fontFamily: fonts.regular, color: theme.subtext || colors.muted, marginTop: 4, lineHeight: 17 }}>
                Your mentor profile is currently under review by TCM One Administration. Access to dashboard features—including course publishing, live class scheduling, student management, and payouts—will be automatically unlocked upon approval.
              </Text>
            </View>
          </View>
        ) : null}
            ...
            >
              ...
              <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                <View style={{ backgroundColor: theme.badgeBg, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 }}>
                  <Text style={{ fontSize: 11, fontFamily: fonts.bold, color: theme.primary }}>{course.category || "TCM One Information Tech"}</Text>
                </View>
                    ...
                    return (
                      ...
                      >
                        ...
                        <Text style={{ fontSize: 10, color: isSelected ? "#E2E8F0" : theme.subtext, marginTop: 2 }}>
                          Category: {course.category || "TCM One Academy"}
                        </Text>
                      </TouchableOpacity>
                    );
                  })}
