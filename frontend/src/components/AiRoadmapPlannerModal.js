...
export default function AiRoadmapPlannerModal({ visible, onClose, user = {}, courses = [], mentors = [] }) {
  ...
  function handleSendToWhatsApp() {
    ...
    const waMsg =
      ...
      `----------------------------------------\n` +
      `⚡ *PHLAPPY AI ROADMAP & SCHEDULE:*` +
      `\n\n${lastAiMsg.slice(0, 1400)}\n\n----------------------------------------\n` +
      `📲 *Generated by Phlappy AI (TCM One)*\n` +
                ...
                <View style={{ flexDirection: "row", alignItems: "center", gap: 10, flex: 1 }}>
                  ...
                  <View style={{ flex: 1 }}>
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
                      <Text style={{ fontSize: 16, fontFamily: fonts.extraBold, color: "#FFFFFF" }}>Phlappy AI</Text>
                      <View style={{ backgroundColor: "#D13B45", paddingHorizontal: 8, paddingVertical: 2.5, borderRadius: 10 }}>
                        <Text style={{ color: "#FFFFFF", fontFamily: fonts.bold, fontSize: 9.5, letterSpacing: 0.4 }}>PHLAPPY PRO</Text>
                      </View>
                    </View>
                  ...
                  >
                    {msg.sender === "ai" && (
                      <View style={styles.aiHeaderLine}>
                        ...
                        <Text style={[styles.aiHeaderTitle, { color: "#D13B45" }]}>Phlappy AI</Text>
                      </View>
                    )}
                ...
                <View style={{ flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 14 }}>
                  ...
                  <View style={[styles.msgBubble, styles.aiBubble, { backgroundColor: theme.isDark ? "#0F172A" : "#F8FAFC", borderColor: theme.border, flexDirection: "row", alignItems: "center", gap: 8, flex: 1 }]}>
                    ...
                    <Text style={{ fontSize: 12.5, color: theme.subtext, fontFamily: fonts.medium }}>
                      Phlappy AI is designing your Day-by-Day & Monthly roadmap...
                    </Text>
                  </View>
                </View>
              )}
            ...
            <View style={styles.bottomBarWrap}>
              ...
              <View style={styles.inputRow}>
                <TextInput
                  ...
                  placeholder="Ask Phlappy AI what you want to learn or customize plan..."
