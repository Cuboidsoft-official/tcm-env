  ...
  const [supportMessages, setSupportMessages] = useState([
    {
      id: "welcome_1",
      sender: "ai",
      text: "Hello! I am your Phlappy AI Support Specialist 🤖. How can I help you today? Ask about course access, doubt rooms, wallet/coins, or mentor bookings."
    }
  ]);
            ...
            <ScrollView style={{ maxHeight: 220, marginVertical: 8, backgroundColor: activeAppTheme.isDark ? "#1E263B" : "#F8FAFC", borderRadius: 14, padding: 10, borderWidth: 1, borderColor: activeAppTheme.border }}>
              ...
              {askingSupportAi ? (
                <View style={{ flexDirection: "row", alignItems: "center", gap: 6, paddingVertical: 4 }}>
                  ...
                  <Text style={{ fontSize: 11.5, color: activeAppTheme.subtext, fontStyle: "italic" }}>Phlappy AI Support is typing answer...</Text>
                </View>
              ) : null}
            </ScrollView>
