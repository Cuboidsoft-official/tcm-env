  ...
  const posts = [
    {
      ...
      authorAvatarUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=160&q=80",
      verified: true,
      category: "UPSC",
      ...
      media: {
        ...
        carouselImages: [
          "https://images.unsplash.com/photo-1456324504439-367cee3b3c32?auto=format&fit=crop&w=640&q=80",
          "https://images.unsplash.com/photo-1517842645767-c639042777db?auto=format&fit=crop&w=640&q=80",
          "https://images.unsplash.com/photo-1517971129774-8a2b38fa128e?auto=format&fit=crop&w=640&q=80"
        ]
      },
      metrics: { likes: 256, comments: 32, shares: 18 },
    ...
    },
    {
      ...
      verified: true,
      category: "Coding",
      text: "How to reverse a string in Java in 3 different ways!\nWhich one do you prefer?",
      media: {
        kind: "code",
        label: "Coding",
        labelIcon: "briefcase",
      ...
      metrics: { likes: 198, comments: 26, shares: 12 },
      tags: ["#Java", "#String", "#Coding", "#TCM"],
      publishedAt: new Date(Date.now() - 4 * 60 * 60 * 1000)
    },
    {
      _id: "post-design-showcase",
      ...
      verified: true,
      category: "Design",
      text: "Minimal UI Design for an Education App\nFeedback is always appreciated!",
      media: {
        kind: "showcase",
        label: "Design",
        labelIcon: "palette",
        title: "Education App UI",
        subtitle: "Courses, progress and achievements",
        imageUrl: "https://images.unsplash.com/photo-1559028012-481c04fa702d?auto=format&fit=crop&w=960&q=80",
        carouselImages: [
      ...
      metrics: { likes: 274, comments: 41, shares: 16 },
      tags: ["#UIUX", "#Design", "#Education", "#TCM"],
      publishedAt: new Date(Date.now() - 6 * 60 * 60 * 1000)
    },
    {
      _id: "post-campus-gallery",
      authorName: "TCM Academy",
      authorRole: "Official Learning Updates",
      authorAvatarUrl: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=160&q=80",
      verified: true,
      category: "AI / ML",
      text: "Weekend mentorship snapshots from TCM learners.\nSwipe through class moments, doubt solving, and project reviews.",
      media: {
        kind: "showcase",
        label: "Image Post",
        labelIcon: "image-multiple",
        title: "Mentorship Gallery",
        subtitle: "Live class and community highlights",
        imageUrl: "https://images.unsplash.com/photo-1523580494863-6f3031224c94?auto=format&fit=crop&w=960&q=80",
        carouselImages: [
          "https://images.unsplash.com/photo-1523580494863-6f3031224c94?auto=format&fit=crop&w=640&q=80",
      ...
      metrics: { likes: 421, comments: 58, shares: 24 },
      tags: ["#TCM", "#Mentorship", "#Learning", "#Gallery"],
