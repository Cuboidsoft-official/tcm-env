...
export default function AiRoadmapPlannerModal({ visible, onClose, user = {} }) {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          id: `ai_err_${Date.now()}`,
          sender: "ai",
          text: "I've processed your request! Based on your goal, we recommend starting with TCM Full Stack Web Masterclass or AI Specialization. Tap below to export your roadmap to WhatsApp!",
          time: new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })
        }
      ]);
    } finally {
  ...
  function handleSendToWhatsApp() {
    ...
    const waMsg =
      `🎓 *TCM ACADEMY - DAY-BY-DAY & MONTHLY ROADMAP* 🎓\n\n` +
      `👤 *Student Name:* ${userName}\n` +
      `----------------------------------------\n` +
      `⚡ *TCM AI ROADMAP & SCHEDULE:*\n\n` +
              ...
              <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                ...
                <View>
                  <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
                    <Text style={[styles.headerTitle, { color: theme.text }]}>TCM AI</Text>
                    <View style={[styles.aiPill, { backgroundColor: theme.badgeBg }]}>
                      <Text style={[styles.aiPillText, { color: theme.primary }]}>TCM AI</Text>
                    </View>
                  </View>
