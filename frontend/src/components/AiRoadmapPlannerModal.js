...
export default function AiRoadmapPlannerModal({ visible, onClose, user = {} }) {
  ...
  function handleSendToWhatsApp() {
    ...
    const waMsg =
      `🎓 *TCM ACADEMY - DAY-BY-DAY & MONTHLY AI ROADMAP* 🎓\n\n` +
      `👤 *Student Name:* ${userName}\n` +
      `----------------------------------------\n` +
      `🤖 *AI COUNSELOR ROADMAP & SCHEDULE:*\n\n` +
      `${lastAiMsg.slice(0, 1400)}\n\n` +
      `----------------------------------------\n` +
      `📲 *Generated by TCM AI Counselor*\n` +
              ...
              <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                ...
                <View>
                  <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
                    <Text style={[styles.headerTitle, { color: theme.text }]}>TCM AI Counselor</Text>
                    <View style={[styles.aiPill, { backgroundColor: theme.badgeBg }]}>
                      <Text style={[styles.aiPillText, { color: theme.primary }]}>Groq & Gemini AI</Text>
                    </View>
                  </View>
                ...
                >
                  {msg.sender === "ai" && (
                    <View style={styles.aiHeaderLine}>
                      ...
                      <Text style={[styles.aiHeaderTitle, { color: theme.primary }]}>TCM AI Counselor</Text>
                    </View>
                  )}
                  <Text style={[styles.msgText, { color: msg.sender === "user" ? "#FFFFFF" : theme.text }]}>
                    {msg.text}
                  </Text>
              ...
              {loading && (
                <View style={[styles.msgBubble, styles.aiBubble, { backgroundColor: theme.isDark ? "#0F172A" : "#F8FAFC", borderColor: theme.border, flexDirection: "row", alignItems: "center", gap: 8 }]}>
                  ...
                  <Text style={{ fontSize: 13, color: theme.subtext, fontFamily: fonts.medium }}>
                    AI is designing your Day-by-Day & Monthly roadmap...
                  </Text>
                </View>
              )}
            </ScrollView>
            ...
            <View style={styles.bottomBarWrap}>
              ...
              <View style={styles.inputRow}>
                <TextInput
                  ...
                  placeholder="Ask AI what you want to learn or customize your plan..."
